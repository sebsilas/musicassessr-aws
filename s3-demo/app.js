...
function upload_file_to_s3(blob){
	...
	document.getElementById("load").appendChild(para); 
    promise.then(
        function (data) {
			...
			var para = document.createElement("P");                       // Create a <p> node
			var t = document.createTextNode("Your File is still being processed");      // Create a text node
			para.appendChild(t);                                          // Append the text to <p>
...
async function getFile(recordkey) {
	...
	document.getElementById("loading").innerHTML="Processing complete successfully"
